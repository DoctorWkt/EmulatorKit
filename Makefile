...
BINS =  rc2014 rcbus-1802 rcbus-6303 rcbus-6502 rcbus-6509 rcbus-65c816-mini \
	...
	trcwm6809 swt6809 nybbles scmp2 sbc08k mini11 rosco-r2
...
rosco-r2: rosco-r2.o ide.o duart.o mapfile.o monitor.o sdcard.o m68k/lib68k.a
	cc -g3 -o rosco-r2 rosco-r2.o ide.o duart.o mapfile.o monitor.o \
	  sdcard.o m68k/lib68k.a -lreadline
